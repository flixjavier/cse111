...
def main():
  ...
  chemical_mass = float(input("Enter the mass in grams of the sample: "))

  # Call the make_periodic_table function and
  # store the periodic table in a variable.

  elements_periodic_table = make_periodic_table() #create element dict

  know_molecules_dict = make_molecules_dict() # Create molecules names dict

  formula_name = get_formula_name(chemical_formula, know_molecules_dict)

  # Call the parse_formula function to convert the
  # chemical formula given by the user to a compound
  # list that stores element symbols and the quantity
  # of atoms of each element in the molecule.
  elements_list = parse_formula(chemical_formula, elements_periodic_table)

  # Call the compute_molar_mass function to compute the
  # molar mass of the molecule from the compound list.
  molar_mass = compute_molar_mass(elements_list, elements_periodic_table)
  # Compute the number of moles in the sample.
  number_moles = chemical_mass / molar_mass
  # Compute the number of protons in the formula 
  number_protons = sum_protons(elements_list, elements_periodic_table)

  #Print the know name of the molecule
  print(formula_name)
  # Print the number of protons in the formula
  print(f'The total of protons in {chemical_formula} is: {number_protons}')
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
  ...
  for element in symbol_quantity_list:
    symbol = element[SYMBOL_INDEX] #In the inner list this represent the symbol
    quantity = element[QUANTITY_INDEX] #In the inner list this represent the quantity
      # Get the atomic mass for the symbol from the dictionary
    for key, value in periodic_table_dict.items():  # UNPACKING remember that this allow you to go to each element in the dict and get the Key and the Value. 
      if symbol == key:
        atomic_mass = value[ATOMIC_MASS_INDEX]
        # Multiply the atomic mass by the quantity.
        atomic_mass_product = atomic_mass * quantity
        # Add the product into the total molar mass.
        total_molar_mass += atomic_mass_product
...
def get_formula_name(formula, known_molecules_dict):
  ...
  if formula in known_molecules_dict:
    ...
    return f'You enter the {value} formula'
  else:
    return f'You enter an unknown compound'
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
  ...
  for element in symbol_quantity_list:
    symbol = element[SYMBOL_INDEX] #In the inner list this represent the symbol
    quantity = element[QUANTITY_INDEX] #In the inner list this represent the quantity
      # Get the number of protons for the symbol from the dictionary
    for key, value in periodic_table_dict.items():  # UNPACKING remember that this allow you to go to each element in the dict and get the Key and the Value. 
      if symbol == key:
        protons = value[ATOMIC_NUMBER_INDEX]
        # Multiply the protons by the quantity.
        number_protons = protons * quantity
        # Add the product into the total protons.
        total_protons += number_protons

  # Return the total number of protons.
  return total_protons #put the return in the correct indent
